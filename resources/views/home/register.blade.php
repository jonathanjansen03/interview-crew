    ...
    <div class="flex flex-col justify-center absolute bg-white drop-shadow-lg inset-y-14 w-fit h-fit py-10 px-6 rounded-xl">
        ...
        <form action="" class="flex flex-col mt-5">
            <div class="flex flex-col">
                ...
                <input type="text" id="update-name" class="border px-2 py-1 rounded-lg bg-slate-200 focus:border-sky-500 focus:outline-none">
            </div>
            ...
            <div class="flex flex-col mt-5">
                ...
                <input type="text" id="update-email" class="border px-2 py-1 rounded-lg bg-slate-200 focus:border-sky-500 focus:outline-none">
            </div>

            <div class="flex flex-col mt-5">
                <label for="update-phone" class="font-medium">Phone</label>
                <input type="text" id="update-phone" class="border px-2 py-1 rounded-lg bg-slate-200 focus:border-sky-500 focus:outline-none">
            </div>
